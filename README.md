...
src/
  main.js               مُشغّل + قائمة اختيار اللعبة
...
**الفكرة:** كل شي تحت `engine/` هو المحرك العام. الألعاب تحت `games/` تُبنى فوقه بدون ما تلمس داخليّاته — **لعبتان مختلفتان تماماً بنفس المحرك**. تختار اللعبة من القائمة عند الفتح (أو مباشرة عبر `?game=climb`).
